...
{
    public partial class ViewEmployerQueryReply : System.Web.UI.Page
    {
        ...
        private void getLoggedQueries()
        {
            try
            {
                ...
                if (t.ViewPortalQuery(RegNo, long.Parse(txtQueryID.Value)) != null)
                {
                    DataRow rw = t.ViewPortalQuery(RegNo, long.Parse(txtQueryID.Value)).Tables[0].Rows[0];
