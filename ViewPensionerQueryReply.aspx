<%@ Page Title="" Language="C#" MasterPageFile="~/PensionerLog.Master" AutoEventWireup="true" CodeBehind="ViewPensionerQueryReply.aspx.cs" Inherits="PenPortfolio.ViewPensionerQueryReply" %>
																	...
																	<div class="col-md-6">
                                                                        ...
                                                                        <div class="form-group">
																		     ...
																		     <div class="form-group">
																				...
																				<div class="col-md-9">
																					<asp:TextBox ID="txtAction" placeholder="Action Type" ReadOnly="true" CssClass="form-control" runat="server"></asp:TextBox>
