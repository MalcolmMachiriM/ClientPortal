<%@ Page Title="" Language="C#" MasterPageFile="~/EmployerLog.Master" AutoEventWireup="true" CodeBehind="PensionerRegister.aspx.cs" Inherits="PenPortfolio.PensionerRegister" %>
            ...
            <td colspan="2">
                <asp:Button ID="btnSearch" OnClick="btnSearch_Click" CssClass="btn btn-primary" runat="server" Text="Filter Search" />
                    ...
                    AutoGenerateColumns="False" AutoGenerateSelectButton="false" OnPageIndexChanging="grdClientsView_PageIndexChanging"
                            ...
                            <Columns>
                             <asp:BoundField DataField="PensionNo" HeaderText="PensionNo"></asp:BoundField>
                                ...
                                <asp:BoundField DataField="LastName" HeaderText="LastName"></asp:BoundField>
                                        <asp:BoundField DataField="NationalID" HeaderText="NationalID"></asp:BoundField>                                      
                                        <asp:BoundField DataField="FormerCoName" HeaderText="BranchName"></asp:BoundField>
                                <%--<asp:BoundField DataField="DateOfBirth" HeaderText="DateOfBirth"></asp:BoundField>--%>
                                <asp:BoundField DataField="PensionType" HeaderText="PensionType"></asp:BoundField>
                                <%--<asp:BoundField DataField="NetSalary" HeaderText="Net Salary"></asp:BoundField>--%>
                                
                                
                                                   <asp:TemplateField HeaderText="View">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkRecDel" runat ="server" ForeColor="Green" CssClass="fa fa-file-archive-o fa-2x" CommandArgument='<%#Eval("PensionNo")%>' CommandName ="selectrecord" ></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>                                                                                                                  
