<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ValidateEmailAddress.aspx.cs" Inherits="PenPortfolio.ValidateEmailAddress" %>
											...
											<div class="app-login-box">
												...
												<div class="app-login-box-user">
													...
													<div class="app-login-box-title">
														...
														<div class="subtitle">Please Enter Login Code</div>
													</div>
													<div class="app-login-box-container">
                                                        ...
                                                        <table style="width:100%">
                                                            ...
                                                            <tr>
                                                                <td colspan="12">
                                                                    <asp:TextBox ID="txtLoginCode" CssClass="form-control" placeholder="Login Code" runat="server"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="12"><hr /></td>
                                                            ...
                                                            <tr>
                                                                <td colspan="12" style="text-align:center">
                                                                    <asp:Button ID="btnValidateEmail" OnClick="btnValidateEmail_Click" Width="100%" CssClass="btn btn-warning" runat="server" Text="Validate Code" />
