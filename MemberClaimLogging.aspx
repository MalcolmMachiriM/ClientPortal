<%@ Page Title="" Language="C#" MasterPageFile="~/MemberLog.Master" AutoEventWireup="true" CodeBehind="MemberClaimLogging.aspx.cs" Inherits="PenPortfolio.MemberClaimLogging" %>
                ...
                <form class="form-horizontal">
                    ...
                    AutoGenerateColumns="False" 
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <asp:DropDownList ID="cboClaimType" AutoPostBack="true" OnSelectedIndexChanged="cboClaimType_SelectedIndexChanged" CssClass="form-control dropdown" runat="server">
                                    </asp:DropDownList>
                                </td>
                            ...
                            <tr>
                                <td colspan="12" style="text-align: center">
                                    ...
                                    <asp:Button ID="btnSaveClaim" CssClass="btn btn-primary" OnClick="btnSaveClaim_Click" runat="server" Text="Save Claim" />
