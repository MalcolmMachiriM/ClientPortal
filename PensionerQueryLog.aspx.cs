...
{
    public partial class PensionerQueryLog : System.Web.UI.Page
    {
                ...
                using (BinaryReader br = new BinaryReader(fs))
                {
                    ...
                    using (SqlConnection con = new SqlConnection(constr))
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand(query))
                        {
                            ...
                            cmd.Parameters.Add("@Type", SqlDbType.VarChar).Value = "P";
        ...
        protected void grdEmployees_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "selectrecord")
            {
                ...
                Response.Redirect(string.Format("ViewPensionerQueryReply.aspx?FundID={0}&SystemRef={1}&QueryID={2}", FundID, txtRecID.Value, index), false);
            }
        }
    }
}